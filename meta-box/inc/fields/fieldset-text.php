...
if ( ! class_exists( 'SW_META_Fieldset_Text_Field' ) )
{
	class SW_META_Fieldset_Text_Field extends SW_META_Field
	{
		/**
		 * Get field HTML
		 *
		...
		static function html( $meta, $field )
		{
			...
			$tpl = '<label>%s <input type="text" class="SW_META-fieldset-text" name="%s[%s][%d]" placeholder="%s" value="%s" /></label>';
