...
require_once SW_META_FIELDS_DIR . 'taxonomy.php';

if ( ! class_exists( 'SW_META_Taxonomy_Advanced_Field' ) )
{
	class SW_META_Taxonomy_Advanced_Field extends SW_META_Taxonomy_Field
	{
		/**
