...
require_once SW_META_FIELDS_DIR . 'select-advanced.php';
require_once SW_META_FIELDS_DIR . 'checkbox-list.php';

if ( ! class_exists( 'SW_META_Taxonomy_Field' ) )
{
	class SW_META_Taxonomy_Field extends SW_META_Field
	{
		/**
		...
		{
			SW_META_Select_Advanced_Field::admin_enqueue_scripts();
			wp_enqueue_style( 'SW_META-taxonomy', SW_META_CSS_URL . 'taxonomy.css', array(), SW_META_VER );
			wp_enqueue_script( 'SW_META-taxonomy', SW_META_JS_URL . 'taxonomy.js', array( 'jquery', 'SW_META-select-advanced', 'wp-ajax-response' ), SW_META_VER, true );
		}
		...
		static function normalize_field( $field )
		{
			...
			switch ( $field['options']['type'] )
			{
				case 'select_advanced':
					$field = SW_META_Select_Advanced_Field::normalize_field( $field );
					break;
				case 'checkbox_list':
				case 'checkbox_tree':
					$field = SW_META_Checkbox_List_Field::normalize_field( $field );
					break;
				case 'select':
				case 'select_tree':
					$field = SW_META_Select_Field::normalize_field( $field );
					break;
				default:
