...
if ( ! class_exists( 'SW_META_User_Field' ) )
{
	class SW_META_User_Field extends SW_META_Field
	{
		/**
		...
		static function html( $meta, $field )
		{
			...
			{
				case 'select':
					return SW_META_Select_Field::html( $meta, $field );
					break;
				case 'select_advanced':
				default:
					return SW_META_Select_Advanced_Field::html( $meta, $field );
			}
		}
		...
		static function meta( $post_id, $saved, $field )
		{
			...
			return SW_META_Select_Field::meta( $post_id, $saved, $field );
		}
