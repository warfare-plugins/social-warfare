<?php
add_action( 'admin_init', 'SW_META_register_meta_boxes' );
 ...
 * @return void
 */
function SW_META_register_meta_boxes()
{
	$meta_boxes = apply_filters( 'SW_META_meta_boxes', array() );
	foreach ( $meta_boxes as $meta_box )
	{
		new SW_Meta_Box( $meta_box );
	}
}

add_action( 'edit_page_form', 'SW_META_fix_page_template' );
 ...
 * @since 4.3.10
 */
function SW_META_fix_page_template( $post )
{
