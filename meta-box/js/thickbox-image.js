jQuery( function ( $ )
{
	...
	$( 'body' ).on( 'click', '.SW_META-thickbox-upload', function ()
	{
		var $this = $( this ),
			$holder = $this.siblings( '.SW_META-images' ),
			post_id = $( '#post_ID' ).val(),
		...
		window.send_to_editor = function ( html )
		{
			...
			html = '<li id="item_' + id + '">';
			html += '<img src="' + url + '">';
			html += '<div class="SW_META-image-bar">';
			html += '<a class="SW_META-delete-file" href="#" data-attachment_id="' + id + '">×</a>';
			html += '</div>';
