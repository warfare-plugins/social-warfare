...
function t(){a(".nc_socialPanel").length&&(C(),a.when(socialWarfarePlugin.setWidths(!0)).done(function(){setTimeout(function(){socialWarfarePlugin.setWidths(!0,!1,!0)},200)}),A(),a(c).scrollTop(),B(),w(),socialWarfarePlugin.activateHoverStates())}function D(){var d=a.extend({wrap:'<div class="sw-pinit" />',pageURL:document.URL},d);a(".swp-content-locator").parent().find("img").each(function(){var b=a(this);if(!(b.outerHeight()<swpPinIt.minHeight||b.outerWidth()<swpPinIt.minWidth)){var e=!1;b.data("media")?
e=b.data("media"):b[0].src&&(e=b[0].src);if(e){var f="";b.attr("title")?f=b.attr("title"):b.attr("alt")&&(f=b.attr("alt"));var e="http://pinterest.com/pin/create/bookmarklet/?media="+e+"&url="+d.pageURL+"&is_video=false&description="+encodeURIComponent(f),f=b.attr("class"),q=b.attr("style");b.removeClass().attr("style","").wrap(d.wrap);b.after('<a href="'+encodeURI(e)+'" class="sw-pinit-button sw-pinit-'+swpPinIt.vLocation+" sw-pinit-"+swpPinIt.hLocation+'">Save</a>');b.parent(".sw-pinit").addClass(f).attr("style",
...
"&swp_cache=rebuild":"?swp_cache=rebuild",a.get(swpCacheURL+d));swpPinIt.enabled&&D()})})(this,jQuery);
