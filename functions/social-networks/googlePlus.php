...
*                                                                *
******************************************************************/
	add_filter('sw_button_options', 'sw_googlePlus_options_function',20);
	function sw_googlePlus_options_function($options) {
...
******************************************************************/
	...
	function sw_googlePlus_button_html($array) {
		...
		elseif( ($array['options']['newOrderOfIcons']['googlePlus'] && !isset($array['buttons'])) || (isset($array['buttons']) && isset($array['buttons']['googlePlus']))  ):
