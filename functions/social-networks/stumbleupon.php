...
*                                                                *
******************************************************************/
	add_filter('sw_button_options', 'sw_stumbleupon_options_function',20);
	function sw_stumbleupon_options_function($options) {
...
******************************************************************/
	...
	function sw_stumbleupon_button_html($array) {
		...
		elseif( ($array['options']['newOrderOfIcons']['stumbleupon'] && !isset($array['buttons'])) || (isset($array['buttons']) && isset($array['buttons']['stumbleupon']))  ):
