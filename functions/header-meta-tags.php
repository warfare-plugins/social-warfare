...
function swp_add_header_meta() {
	...
	if ( swp_is_cache_fresh( $info['postID'] , true ) == false ) :
		 ...
		 *
		 * All meta values will be returned in the $info['meta_tag_values'] index.
		 *
		 ...
		 * OG Modified Time:		$info['meta_tag_values']['article_modified_time'] (Just use the same as above)
